...
CREATE INDEX CONCURRENTLY idx_regime_urbanistico_zot_bairro 
ON regime_urbanistico_detalhado (zot, bairro);

-- Height search optimization  
DROP INDEX IF EXISTS idx_regime_urbanistico_altura;
CREATE INDEX CONCURRENTLY idx_regime_urbanistico_altura 
ON regime_urbanistico_detalhado (altura_maxima_m) 
WHERE altura_maxima_m IS NOT NULL;

-- Multi-column search for urban parameters
DROP INDEX IF EXISTS idx_regime_urbanistico_composite;
CREATE INDEX CONCURRENTLY idx_regime_urbanistico_composite 
ON regime_urbanistico_detalhado (zot, bairro, altura_maxima_m);
...
ANALYZE regime_urbanistico_detalhado;
ANALYZE query_cache;
