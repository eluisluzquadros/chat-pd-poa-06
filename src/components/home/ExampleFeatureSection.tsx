...
export const ExampleFeatureSection = () => {
  ...
  return (
    <>
      ...
      >
        <FeatureSection
          title="Agilize suas consultas especializadas"
          description="Nossa plataforma integra inteligência artificial com bases de conhecimento especializadas para fornecer respostas precisas e detalhadas em segundos, economizando horas de pesquisa manual."
      ...
      >
        <FeatureSection
          ...
          description="Compreenda rapidamente os parâmetros e regulamentações aplicáveis ao seu contexto, incluindo índices, critérios e requisitos específicos, sem precisar navegar por múltiplos documentos."
